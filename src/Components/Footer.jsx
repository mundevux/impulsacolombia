        ...
        <div className="m-auto">
          <div className="grid grid-cols-5">
            <div className="col-span-5 lg:col-span-1">
              <Link
                to="/"
                aria-label="logo"
                className="flex space-x-2 items-center pb-4"
              >
            ...
            <div className="text-gray-600 dark:text-gray-300 col-span-5 lg:col-span-1 py-2">
              ...
              <div className="flex flex-col py-3">
                <a
                  href="https://goo.gl/maps/A4KfcVYH7sY6ZP9V7"
                  className="text-shark-300 text-base font-normal pb-2"
                  target="_blank"
                >
                  Calle 98 22 64 Oficina 701
                </a>
                <p className="text-shark-300 text-base font-normal pb-2">
                  Bogotá, Colombia
                </p>
              </div>
              <div className="flex flex-col py-3">
                <p className="text-shark-300 text-base font-normal pb-2">
                  Disponible de Lunes a Vienes
                </p>
                <p className="text-amber-500 text-base font-normal pb-2">
                  8:00 am - 5:00 pm
                </p>
              </div>
            </div>
            <div className="text-gray-600 dark:text-gray-300 col-span-5 lg:col-span-1 py-2">
              ...
              <ul className="flex flex-col justify-center">
                <li>
                  <Link
                    to="/"
                    className="transition text-shark-300 text-base font-normal hover:text-amber-500"
                  >
                    Inicio
                  </Link>
                </li>
            ...
            <div className="col-span-5 lg:col-span-1 py-2">
              ...
              <div className="flex flex-col py-3">
                <a
                  href="mailto:info@impulsacolombia.com.co"
                  className="text-shark-300 text-base font-normal pb-2"
                >
                  info@impulsacolombia.com.co
                </a>
              </div>
            </div>
            <div className="col-span-5 lg:col-span-1 py-2">
              ...
              <div className="flex flex-col py-3">
                <a
                  href="tel:+576017942134"
                  className="text-shark-300 text-base font-normal pb-2"
                >
                  (601) 794 2134
                </a>
                <a
                  href="tel:+573176676375"
                  className="text-shark-300 text-base font-normal pb-2"
                >
                  (317) 667 6375
                </a>
          ...
          <div className="text-center mt-3 border-t-2  border-primary dark:border-secondary">
            <span className="block text-xs text-gray-500 dark:text-gray-400 mt-2">
              Copyright &copy; <span id="year">2023</span> by{" "}
              <a href="https://codcreativo.com/" target="_blank">
                Código Creativo
              </a>
              . All rights reserved.
            </span>
