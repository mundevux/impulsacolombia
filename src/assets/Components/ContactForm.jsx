    ...
    <div className="container mx-auto py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <form className=" bg-white shadow-md rounded-md px-8 pt-6 pb-8 mb-4 " onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                    <label htmlFor="tel" className="block text-gray-700 font-medium mb-2">Número Telefónico</label>
                ...
                <div className="mb-4">
                    <label htmlFor="project" className="block text-gray-700 font-medium mb-2">Proyecto de interés</label>
