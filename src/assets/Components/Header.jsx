            ...
            <nav className="z-10 w-full backdrop-blur-2xl">
                <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                    <div className="flex flex-wrap items-center justify-around py-2 gap-6 md:py-4 md:gap-0 relative">
                        ...
                        <div className="flex-col z-20 flex-wrap gap-6 p-8 rounded-3xl border border-gray-100 bg-white shadow-2xl shadow-gray-600/10 justify-between w-full invisible opacity-0 translate-y-1  absolute top-full left-0 transition-all duration-300 scale-95 origin-top 
                            ...
                            <div className="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
                                <ul className="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
                                    <li>
                                        <a href="#home" className="block md:px-4 transition text-base text-[#00223B] hover:text-amber-500 hover: dark:text-white ">
                                            <span>Inicio</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#aboutus" className="block md:px-4 transition text-base text-[#00223B] hover:text-amber-500 hover: dark:text-white ">
                                            <span>Nosotros</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#proyects" className="block md:px-4 transition text-base text-[#00223B] hover:text-amber-500 hover: dark:text-white">
                                            <span>Proyectos</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#contact" className="block md:px-4 transition text-base text-[#00223B] hover:text-amber-500 hover: dark:text-white">
                                            <span>Contacto</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#blog" className="block md:px-4 transition text-base text-[#00223B] hover:text-amber-500 dark:text-white">
                                            <span>Blog</span>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div className='flex justify-center mt-8 lg:mt-0'>
                                <button className='bg-amber-500 text-white text-base font-bold rounded-lg p-2'>Contacto</button>
                            </div>
                        </div>
                    </div>
                </div>
