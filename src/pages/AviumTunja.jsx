...
export function AviumTunja() {
  const salaDeVentas = {
    ...
    linkDirection: "https://maps.app.goo.gl/zjjnQ84Kfc7brfFH9",
    ...
    imageMaps: iconMaps,
    refMaps: "https://maps.app.goo.gl/zjjnQ84Kfc7brfFH9",
    textMaps: "Llega con Maps",
    iframe: (
      <Iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3971.252537296161!2d-73.35855872414724!3d5.52950503391378!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e6a7d614bfa4065%3A0xaff8cb7016e98b1a!2sConjunto%20Residencial%20Avium%20Tunja!5e0!3m2!1ses!2sco!4v1695653484970!5m2!1ses!2sco"
  ...
  return (
    <div>
      <Helmet>
        ...
        <meta
          name="description"
          content="Conjunto Residencial Avium Tunja, apartamentos con piscina en Tunja, Boyacá. Conoce más sobre este proyecto de apartamentos en Tunja, Boyacá."
        />
        <meta
          name="keywords"
          content="Aparatamentos con Piscina, apartamentos en Tunja, apartamentos con piscina en Tunja, "
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-5 ">
          <div className="flex flex-col items-center ">
            <p className="text-base md:text-lg font-medium text-shark-900 pb-2 text-justify">
              Avium Tunja es proyecto de vivienda de estrato 3 que está
              construido en la calle 18 No. 1-140 del sector del Rodeo en la
              ciudad de Tunja. Cuenta con una{" "}
              ...
              Universitaria y a la Avenida Oriental. Un total de 408
              apartamentos distribuidos en{" "}
              <span className="text-amber-500">4 torres de 8 apartamentos</span>{" "}
              por piso, dos de ellas con una altura de 11 pisos y las otras dos
              de 16 pisos, cada una con 2 ascensores.
            </p>
          </div>
