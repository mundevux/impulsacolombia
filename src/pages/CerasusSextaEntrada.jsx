...
export function CerasusSextaEntrada(){
    ...
    const salaDeVentas = {
        ...
        iframe: <Iframe 
                    ...
                    title='Sala de Ventas Cerasus Sexta Entrada'
        ...
        <div>
            ...
            <div className="max-w-7xl mx-auto py-10 px-4 xl:px-6">
                ...
                <div className="flex justify-center items-center -mt-28 relative z-10 pb-6">
                    <img src={logoCerasusSextaEntrada} alt="Logo Conjunto Residencial Cerasus Sexta Entrada apartamentos VIP en Barranquilla" className=" w-52 h-52 rounded-full object-cover" />
                </div> 
                <div className="flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-4xl md:text-5xl font-bold text-shark-900 pb-4">Cerasus Sexta Entrada</h1>
                    <p className="text-lg md:text-xl font-medium text-shark-700">Vivienda de Interés Prioritario en Barranquilla</p>
