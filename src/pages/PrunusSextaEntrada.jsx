...
export function PrunusSextaEntrada() {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Prunus Sexta Entrada | Vivienda de Interés Social en Barranquilla
        </title>
        <meta
          name="description"
          content="Prunus Sexta Entrada es un proyecto de vivienda en Barranquilla, con apartamentos de 53m2, hasta 115 SMMLV, con 2 habitaciones, 1 baño, sala comedor, cocina y zona de ropas."
        />
        <meta
          name="keywords"
          content="Apartamentos en Malambo, Apartamentos en Ballanquilla, Vivienda de interés social en Barranquilla, Vvienda de interés social en Malambo"
        />
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 xl:px-6">
        ...
        <div className="flex flex-col items-center justify-center text-center px-6">
          <h1 className="text-4xl md:text-5xl font-bold text-shark-900 pb-4">
            Prunus Sexta Entrada
          </h1>
          <p className="text-lg md:text-xl font-medium text-shark-700">
            Vivienda de Interés Social en Barranquilla
          </p>
          <p className="text-lg md:text-xl font-medium text-shark-700">
        ...
        <div className="my-32">
          <h1 className="text-4xl md:text-8xl font-bold text-shark-900 text-center">
